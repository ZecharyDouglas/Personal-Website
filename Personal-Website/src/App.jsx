    ...
    <>
      <div className="relative min-h-screen overflow-hidden bg-indigo-950">
        ...
        <div className="flex flex-col min-h-dvh relative z-10 ">
          <div className="flex relative z-10 pt-10 px-10 text-[#605e5e] justify-end ">
          ...
          <div>
            <div className="h-px w-full bg-[#605e5e]" />
          </div>
          {/* Hero Card */}
          <div className="flex justify-center p-10">
            <div className="h-[80vh] w-[90vw] rounded-xl bg-[#7649BF]/25 shadow-lg">
